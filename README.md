...
- `results/` is created during experiments and stores metrics and plots
- `checkpoints/` is created during experiments and stores the best validation checkpoint for each model
